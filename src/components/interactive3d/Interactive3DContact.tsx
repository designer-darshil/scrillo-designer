...
export const Interactive3DContact: React.FC = () => {
  ...
  // Dynamic mailto link carrying current inputs if submission fails or offline
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Success: record name, mark submitted, reset fields
  ...
  return (
    <section id="contact-section" className="py-24 sm:py-32 md:py-40 bg-[#050505] border-b border-white/10 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        ...
        <div className="mb-14 sm:mb-20 pb-8 border-b border-white/10">
          <div className="flex items-center space-x-3 text-xs font-mono tracking-widest text-[#FF3E00] uppercase mb-4">
            ...
            <span className="text-white/60">START A CONVERSATION</span>
          </div>

          <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold uppercase tracking-tight text-white leading-none">
            LET'S WORK <br />
            <span className="text-[#FF3E00]">TOGETHER.</span>
          </h2>
        </div>

        {/* Contact Grid: Direct Info (Left) + Form Card (Right) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          
          {/* Left Column: Direct Details */}
          <div className="lg:col-span-5 space-y-6 sm:space-y-8">
            <p className="text-base sm:text-lg text-white/70 leading-relaxed font-sans">
              Have a digital product to design, a UI/UX project to discuss, or a web interface to build? Reach out directly or fill out the form.
            </p>
          ...
          {/* Right Column: Layered 3D Form Card */}
          <div className="lg:col-span-7">
            <ThreeDCard maxRotation={4} depthZ={12} glareOpacity={0.12}>
              <div className="rounded-3xl border border-white/10 bg-[#0A0A0A] p-6 sm:p-10 shadow-2xl relative [transform-style:preserve-3d]">
                  ...
                  {!isSubmitted ? (
                    ...
                    >
                      ...
                      <div style={{ transform: 'translateZ(20px)' }}>
                        <label htmlFor="form-name" className="text-xs font-mono uppercase tracking-wider text-white/70 block mb-1.5">
                      ...
                      {/* Email */}
                      <div style={{ transform: 'translateZ(20px)' }}>
                        <label htmlFor="form-email" className="text-xs font-mono uppercase tracking-wider text-white/70 block mb-1.5">
                      ...
                      {/* Message */}
                      <div style={{ transform: 'translateZ(20px)' }}>
                        <label htmlFor="form-message" className="text-xs font-mono uppercase tracking-wider text-white/70 block mb-1.5">
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-white/70 text-xs sm:text-sm max-w-md mx-auto leading-relaxed">
                          ...
                          Your inquiry has been sent to <span className="text-white font-mono">{RECIPIENT_EMAIL}</span>. I will respond shortly.
                        </p>
                      </div>
