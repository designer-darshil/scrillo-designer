...
export const SelectedWork: React.FC = () => {
  ...
  return (
    <section id="selected-work" className="py-28 md:py-36 bg-[#050505] border-b border-white/10 relative">
            ...
            return (
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                  ...
                  <div className={`lg:col-span-5 space-y-5 ${isEven ? 'order-2' : 'order-2 lg:order-1'}`}>
                    <div className="text-xs font-mono tracking-wider uppercase text-white/50">
                      {project.roles.join(' • ')}
                    </div>

                    <div className="space-y-2">
                      <h3 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-white group-hover:text-[#FF3E00] transition-colors">
                    ...
                    <div className="pt-2">
                      <Link
                        ...
                        data-cursor="project"
                        className="inline-flex items-center space-x-2 text-xs font-mono uppercase tracking-widest font-bold text-white hover:text-[#FF3E00] transition-colors group/link"
                      >
