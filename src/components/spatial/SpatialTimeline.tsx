...
export const SpatialTimeline: React.FC = () => {
  ...
  return (
    <section id="spatial-timeline" className="section-padding bg-[#050505] border-b border-white/10 relative overflow-hidden select-none">
      <div className="site-container">
        
        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 sm:gap-6 pb-6 sm:pb-8 border-b border-white/10 mb-8 sm:mb-12">
          <div>
        ...
        {/* ========================================================================= */}
        <div className="mb-8 sm:mb-12 overflow-x-auto scrollbar-none pb-2">
          <div className="flex items-center justify-between min-w-[580px] sm:min-w-[620px] p-2 rounded-2xl border border-white/10 bg-[#0A0A0A] relative">
            ...
            {timelineNodes.map((node) => {
              ...
              return (
                <button
                  ...
                  className={`relative z-10 flex flex-col items-center space-y-1.5 py-2.5 sm:py-3 px-4 sm:px-6 rounded-xl transition-all duration-300 min-h-[52px] sm:min-h-[58px] ${
                    isSelected
        ...
        <div className="[perspective:1200px]">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="rounded-2xl sm:rounded-3xl border border-white/15 bg-gradient-to-b from-[#111111] via-[#090909] to-[#050505] p-5 sm:p-8 lg:p-10 shadow-2xl relative overflow-hidden"
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative z-10">
                ...
                <div className="lg:col-span-6 space-y-4">
                  ...
                  <p className="text-sm sm:text-base text-white/70 font-sans leading-relaxed pt-2 text-pretty">
        ...
        {/* Verification Strip */}
        <div className="pt-6 sm:pt-8 mt-6 sm:mt-8 flex flex-wrap items-center justify-between gap-4 font-mono text-xs text-white/30 uppercase tracking-widest border-t border-white/5">
